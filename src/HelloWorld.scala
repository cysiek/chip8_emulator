...
//    c.loadProgramFromFile("C:\\Users\\cysie\\IdeaProjects\\chip8_emulator\\data\\chip8-master\\programs\\Random Number Test [Matthew Mikolay, 2010].ch8")
    c.loadProgramFromFile("C:\\Users\\cysie\\IdeaProjects\\chip8_emulator\\data\\chip8-master\\demos\\Particle Demo [zeroZshadow, 2008].ch8")
    ...
    while (true) {
      ...
      display.show()
      c.executeSingleCycle(display.lastpressedKey)
